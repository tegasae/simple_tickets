...
from src.web.dependencies.auth import require_current_user, get_current_user, get_employee_id_from_request
from src.web.dependencies.services import get_ticket_user_service

router = APIRouter(prefix="/user/tickets", tags=["user tickets"], dependencies=[Depends(get_current_user)])
